...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-950 text-white flex flex-col">
        ...
        <div class="px-4 py-2 relative">
            ...
            <!-- Floating Legend -->
            <div
                class="absolute bottom-4 right-6 bg-black/70 backdrop-blur px-3 py-2 rounded-xl text-xs border border-white/10">
        ...
        <div class="px-4 pt-3">
            <div id="ai-summary"
                class="text-xs text-orange-300 bg-orange-500/10 border border-orange-500/20 rounded-xl px-3 py-2 hidden">
            </div>
        </div>
...
@push('scripts')
    ...
    <script async src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&loading=async&callback=initMap&v=weekly">
    </script>
@endpush
